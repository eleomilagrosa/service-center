...
public class ClosedActivity extends BaseActivity implements
        ...
        switch (process){
            case REQUEST_UPDATE_STATUS:
                if(setJobOrder(response)){
                    Toast.makeText(this, "Closed Job Order Success", Toast.LENGTH_SHORT).show();
    ...
    public void setJobOrderImage(JobOrderImages jobOrderImage,String path){
        ...
        jobOrderImage.setJob_order_status_id(JobOrders.ACTION_CLOSED);
    }
