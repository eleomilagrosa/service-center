...
import com.fusiotec.servicecenterapi.servicecenter.fragments.ForReturnFragment;
...
public class ForReturnActivity extends BaseActivity implements
        JobOrderImagesFragment.JobOrderImagesFragmentListener,
        JobOrderImagesAdapter.JobOrderImagesAdapterListener,
        ForReturnFragment.ShippingFragmentListener,
    ...
    public final static int REQUEST_FOR_RETURN = 301;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        jobOrders.setJobOrderForReturn(new JobOrderForReturn());
        jobOrders.getJobOrderForReturn().setJob_order_id(jobOrders.getId());
    ...
    public void switchFragment(int fragment){
        ...
        switch (fragment){
            case FRAGMENT_JOB_ORDER_SHIPPING:
                ForReturnFragment shippingFragment = new ForReturnFragment();
    ...
    public void setJobOrderImage(JobOrderImages jobOrderImage,String path){
        ...
        jobOrderImage.setJob_order_status_id(JobOrders.ACTION_FOR_RETURN);
    }
    public void save(){
        showProgress(true);
        repair_status();
    ...
    public void repair_status(){
        requestManager.setRequestAsync(requestManager.getApiService().create_job_order_for_return(jobOrders.getId(),jobOrders.getJobOrderForReturn().getShipping_no(),jobOrders.getJobOrderForReturn().getShipping_note(),jobOrders.getJobOrderForReturn().getAccount_id(),jobOrders.getRepair_status()),REQUEST_FOR_RETURN);
    }
