...
public class ShippingFragment extends BaseFragment{
    ...
    public void setValues(){
        et_shopping.setText(jobOrder.getJobOrderShipping().getShipping_no());
        et_shopping_note.setText(jobOrder.getJobOrderShipping().getShipping_note());
    }
    public void saveShipping(String shipping,String shipping_no){
        jobOrder.setStatus_id(JobOrders.ACTION_FORWARDED);
        jobOrder.getJobOrderShipping().setShipping_no(shipping);
        jobOrder.getJobOrderShipping().setShipping_note(shipping_no);
        jobOrder.getJobOrderShipping().setAccount_id(accounts.getId());
        jobOrder.getJobOrderShipping().setDate_created(Utils.getServerDate(ls));
        jobOrder.getJobOrderShipping().setDate_modified(Utils.getServerDate(ls));
    }
