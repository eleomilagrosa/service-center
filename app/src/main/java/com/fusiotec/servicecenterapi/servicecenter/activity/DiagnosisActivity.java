...
import com.fusiotec.servicecenterapi.servicecenter.fragments.DiagnosisFragment;
...
public class DiagnosisActivity extends BaseActivity implements
    ...
    public final static int FRAGMENT_JOB_ORDER_DIAGNOSIS = 2;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        jobOrders.setJobOrderDiagnosis(new JobOrderDiagnosis());
        jobOrders.getJobOrderDiagnosis().setJob_order_id(jobOrders.getId());
    ...
    public void onBackPressed(){
        ...
        }else if(current_fragment == FRAGMENT_JOB_ORDER_DIAGNOSIS){
            alertToExit();
        }else if(current_fragment == FRAGMENT_JOB_ORDER_IMAGES){
            switchFragment(FRAGMENT_JOB_ORDER_DIAGNOSIS);
    ...
    public void switchFragment(int fragment){
        ...
        switch (fragment){
            case FRAGMENT_JOB_ORDER_DIAGNOSIS:
                DiagnosisFragment diagnosisFragment = new DiagnosisFragment();
                diagnosisFragment.setJobOrder(jobOrders);
                setFragment(diagnosisFragment,before_fragment,current_fragment);
                break;
